...
export const sleepRandom = (min: number = 500, max: number = 3000): Promise<void> =>
...
export const getExecutablePath = (): string => {
  ...
  if (platform == 'mac')
    return path.resolve(PATH_ROOT, 'browser', 'Orbita-Browser.app', 'Contents', 'MacOS', 'Orbita')
  else if (platform == 'win')
    return path.resolve(PATH_ROOT, 'browser', 'orbita-browser', 'chrome.exe')
